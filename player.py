...
class Player(pygame.sprite.Sprite):
    def __init__(self, game_mode):
        ...
        if self.game_mode == "Neuroevolution":
            ...
            layer_sizes = [3, 20, 2]  # TODO (Design your architecture here by changing the values)
    ...
    def think(self, screen_width, screen_height, obstacles, player_x, player_y):
        ...
        :param obstacles: List of obstacles tha3 are above the player. Each entry is a dictionary having 'x' and 'y' of
        ...
        for i in range(2):
            if i >= len(obstacles):
                ...
                input.append([obstacles[i]['y']])
        try:
            input.append([abs(player_x - obstacles[0]['x'])])
        except:
